...
async def menu_buy(message: types.Message):
    text = (
        "\U0001f525 Подключая VPN от «Мировые анекдоты», вы получаете не просто сервис, "
        "а анекдот в каждом мегабайте:\n\n"
        "🚀 Летит, как хорошая шутка в пятничный вечер — быстро и стабильно\n"
        "👥 Поддержка, как верный друг в баре — всегда на связи (@andekdot_support)\n"
        "🖥 Работает везде — хоть на айфоне, хоть на утюге (iOS, Android, Windows, MacOS, Android TV)\n"
        "🔑 Один ключ — одно устройство. Всё честно, как у старого грузина в анекдоте\n"
        "🛠 Настройка простая — справится даже тёща. 2 минуты, и вы в безопасности\n"
        "✅ Безлимитный трафик — как анекдоты у деда: сколько ни слушай — всё мало\n"
        "🔕 Никакой рекламы — только вы и интернет, без “а сейчас минутка спонсора”\n"
        "⛔️ Никаких автосписаний — всё под вашим контролем, как в хорошем тосте\n\n"
        "💡 Лайфхак: чем дольше срок — тем выгоднее. Как говорится, лучше платить редко, но метко 😉\n"
        "▶️ Выбирайте тариф ниже и подключайтесь — пусть шутки будут в Telegram, а не с вашим интернетом!"
    )
